...
package uk.gov.hmrc.singlecustomeraccountwrapperdata.utils

import uk.gov.hmrc.auth.core.Enrolment
import uk.gov.hmrc.auth.core.retrieve.v2.TrustedHelper
import uk.gov.hmrc.domain.SaUtr
import uk.gov.hmrc.singlecustomeraccountwrapperdata.models.auth.{Activated, EnrolmentStatus, NotYetActivated, SelfAssessmentEnrolment}
